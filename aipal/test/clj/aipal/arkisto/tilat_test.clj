...
(deftest ^:integration kyselykerran-tilat-kun-kysely-julkaistu-test
...
(deftest ^:integration kyselykerran-tilat-kun-kysely-luonnostilassa-test
...
(deftest ^:integration kyselykerran-tilat-kun-kysely-poistettu-test
...
(deftest ^:integration vastaajatunnus-ei-kaytettavissa-kun-kysely-poistettu-test
  (let [kysely (lisaa-kysely! {:tila "poistettu"})
        kyselykerta (lisaa-kyselykerta! {:lukittu false} kysely)
...
(deftest ^:integration vastaajatunnuksen-tilat-kun-kyselykerta-ei-ole-lukittu-test
  (let [kysely (lisaa-kysely! {:tila "julkaistu"})
        kyselykerta (lisaa-kyselykerta! {:lukittu false} kysely)
...
(deftest ^:integration vastaajatunnuksen-tilat-kun-kyselykerta-on-lukittu-test
  (let [kysely (lisaa-kysely! {:tila "julkaistu"})
