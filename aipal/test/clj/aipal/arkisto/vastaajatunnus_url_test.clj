...
(deftest tunnukset-ovat-yksilollisia
  "Tarkistetaan että funktio osaa tarkastaa oikein jo luotujen tunnusten joukon."
  []
...
(deftest luonti-lopettaa-aina
  "Tunnuksen luonti ei jää ikuiseen silmukkaan jos kaikki mahdolliset tunnukset on jo luotu."
  []
