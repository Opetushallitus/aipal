...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'src/bower_components/angular-placeholder-shim/angular-placeholder-shim.min.js',
      'src/bower_components/jquery-html5-placeholder-shim/jquery.html5-placeholder-shim.js',
