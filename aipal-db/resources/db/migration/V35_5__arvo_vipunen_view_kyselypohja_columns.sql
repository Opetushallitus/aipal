...
regexp_replace(kyselypohja.nimi_fi::text, '\n'::text, ' '::text, 'g'::text) AS kyselypohja_fi,
regexp_replace(kyselypohja.nimi_sv::text, '\n'::text, ' '::text, 'g'::text) AS kyselypohja_sv,
regexp_replace(kyselypohja.nimi_en::text, '\n'::text, ' '::text, 'g'::text) AS kyselypohja_en,
...
kysymysryhma_kyselypohja.jarjestys AS kyselypohjajarjestys,
...
LEFT JOIN kysymysryhma_kyselypohja ON kysymysryhma_kyselypohja.kysymysryhmaid = kysymysryhma.kysymysryhmaid
LEFT JOIN kyselypohja ON kyselypohja.kyselypohjaid = kysymysryhma_kyselypohja.kyselypohjaid
